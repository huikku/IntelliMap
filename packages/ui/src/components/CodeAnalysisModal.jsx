...
`;
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
      <div className="bg-[#000000] border-2 border-[#2a2a2a] rounded-lg shadow-2xl max-w-3xl w-full mx-4 max-h-[90vh] flex flex-col">
        {/* Header */}
          ...
          {['overview', 'issues', 'metrics'].map(tab => (
            <button
              ...
              className={`px-4 py-2 text-sm font-semibold transition ${
                activeTab === tab
                  ? 'bg-[#000000] text-white border-b-2 border-blue-500'
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="bg-[#0a0a0a] rounded-lg p-4 border border-[#2a2a2a]">
                  ...
                  <div className="text-xs text-[#6a6a6a] uppercase tracking-wide">Files</div>
                </div>
                <div className="bg-[#0a0a0a] rounded-lg p-4 border border-[#2a2a2a]">
                  <div className="text-2xl font-bold text-green-400">{analysis.totalEdges}</div>
                  <div className="text-xs text-[#6a6a6a] uppercase tracking-wide">Dependencies</div>
                </div>
                <div className="bg-[#0a0a0a] rounded-lg p-4 border border-[#2a2a2a]">
                  <div className="text-2xl font-bold text-purple-400">{avgDependencies.toFixed(1)}</div>
                  <div className="text-xs text-[#6a6a6a] uppercase tracking-wide">Avg Deps/File</div>
                </div>
              </div>

              {/* Quick Stats */}
              <div className="bg-[#0a0a0a] border border-[#2a2a2a] rounded-lg p-4 space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-[#6a6a6a]">Maximum Depth:</span>
                  <span className="text-white font-semibold">{maxDepth} levels</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#6a6a6a]">Largest Component:</span>
                  <span className="text-white font-semibold">{largestComponents[0]?.size || 0} files</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#6a6a6a]">Hub Files (high fan-out):</span>
                  <span className="text-white font-semibold">{hubNodes.length}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#6a6a6a]">Leaf Files (high fan-in):</span>
